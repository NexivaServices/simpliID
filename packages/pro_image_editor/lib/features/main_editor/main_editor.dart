...
class ProImageEditorState extends State<ProImageEditor>
  ...
  /// Calls the remove background callback from the parent widget.
  void _removeBackground() {
    if (callbacks.removeBackground != null) {
      callbacks.removeBackground!();
    }
  }
  ...
  Widget? _buildBottomNavBar() {
    ...
    return hasSelectedLayers &&
        ...
        : MainEditorBottombar(
            ...
            openRemoveBackground: _removeBackground,
          );
  }
